...
export default function ProductDetailPage() {
  ...
  const specs = [
    ...
    { name: "Penyelesaian", value: "Teknisi penyesuaian; gunner / penyawat tekstil penyederhauan art-stiling rata-penyusulan" },
    { name: "Asal", value: "Pembatian, Pengagun, Penggugunan; Portugal" },
  ]
      ...
      <div className="grid grid-cols-2 gap-12 px-6 py-12 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-8">
          ...
          <p className="text-gray-600 font-light leading-relaxed">
            Kaos oversiz yang dibuat dengan material padai yang memberikan kenyamanan luar biasa dalam setiap penggunaan harian. Dengan jahitan yang kuat dan desain modern yang timeless, koleksi kami menawarkan kualitas premium dengan harga yang terjangkau.
          </p>
