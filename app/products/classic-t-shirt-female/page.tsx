...
export default function ClassicTShirtFemale() {
  ...
  const specs = [
    ...
    { name: "Struktur", value: "Jahit halus dengan fitted female cut" },
    { name: "Penyelesaian", value: "Ribbed collar dengan tapered sleeves" },
      ...
      <div className="grid grid-cols-2 gap-12 px-6 py-12 max-w-7xl mx-auto">
              ...
              <g id={`view-${slides[currentSlide].view}`}>
                {currentSlide === 0 && (
                  <>
                    ...
                    />
                    {/* Sleeves - Tapered */}
                    <path d="M 50 125 L 35 150 L 35 200 L 110 180" fill="#f5f5f5" stroke="#333" strokeWidth="2" />
                    <path d="M 350 125 L 365 150 L 365 200 L 290 180" fill="#f5f5f5" stroke="#333" strokeWidth="2" />
                    {/* Neckline */}
                ...
                {currentSlide === 1 && (
                  <>
                    ...
                    />
                    {/* Sleeves - Tapered */}
                    <path d="M 50 125 L 35 150 L 35 200 L 110 180" fill="#e8e8e8" stroke="#333" strokeWidth="2" />
                    <path d="M 350 125 L 365 150 L 365 200 L 290 180" fill="#e8e8e8" stroke="#333" strokeWidth="2" />
                    {/* Neckline */}
                    <circle cx="200" cy="92" r="22" fill="white" stroke="#333" strokeWidth="2" />
                    {/* Design Detail */}
                    <text x="200" y="250" textAnchor="middle" fontSize="24" fontWeight="bold" fill="#999">
                ...
                {currentSlide === 2 && (
                  <>
                    ...
                    />
                    {/* Sleeve */}
                    <path d="M 100 125 L 85 150 L 85 200 L 160 180" fill="#ececec" stroke="#333" strokeWidth="2" />
                    {/* Neckline */}
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-bold">Classic T-Shirt</h1>
            {/* T-Shirt Icon SVG */}
            <svg
          ...
          <p className="text-gray-600 font-light leading-relaxed">
            T-shirt klasik untuk wanita dengan potongan fitted yang elegan dan nyaman. Dibuat dari bahan katun organik berkualitas tinggi dengan sleeves yang tapered. Desain timeless yang sempurna untuk berbagai occasion dan styling.
          </p>
