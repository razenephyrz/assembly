...
export default function BoxyTShirtPage() {
  ...
  const specs = [
    ...
    { name: "Kain", value: "Komposisi: 100% katun organik. Berat: 160g/m²" },
    { name: "Struktur", value: "Jahit kuat dengan oversized boxy cut" },
    { name: "Penyelesaian", value: "Ribbed collar dengan relaxed fit" },
      ...
      <div className="grid grid-cols-2 gap-12 px-6 py-12 max-w-7xl mx-auto">
              ...
              <g id={`view-${slides[currentSlide].view}`}>
                {currentSlide === 0 && (
                  <>
                    {/* Front View - Boxy */}
                    <path
                      d="M 80 100 L 60 130 L 60 400 L 340 400 L 340 130 L 320 100 Z"
                      fill="#f5f5f5"
                      stroke="#333"
                      strokeWidth="2"
                    />
                    {/* Sleeves - Oversized */}
                    <rect x="10" y="130" width="70" height="130" fill="#f5f5f5" stroke="#333" strokeWidth="2" />
                    <rect x="320" y="130" width="70" height="130" fill="#f5f5f5" stroke="#333" strokeWidth="2" />
                    {/* Neckline */}
                    <circle cx="200" cy="100" r="30" fill="white" stroke="#333" strokeWidth="2" />
                    {/* Design Detail */}
                ...
                {currentSlide === 1 && (
                  <>
                    ...
                    />
                    {/* Sleeves - Oversized */}
                    <rect x="10" y="130" width="70" height="130" fill="#e8e8e8" stroke="#333" strokeWidth="2" />
                    <rect x="320" y="130" width="70" height="130" fill="#e8e8e8" stroke="#333" strokeWidth="2" />
                    {/* Neckline */}
                    <circle cx="200" cy="100" r="30" fill="white" stroke="#333" strokeWidth="2" />
                    {/* Design Detail */}
                    <text x="200" y="250" textAnchor="middle" fontSize="24" fontWeight="bold" fill="#999">
                ...
                {currentSlide === 2 && (
                  <>
                    {/* Side View - Boxy */}
                    <path
                      d="M 140 100 L 120 130 L 120 400 L 280 400 L 280 130 L 260 100 Z"
                      fill="#ececec"
                      stroke="#333"
                      strokeWidth="2"
                    />
                    {/* Sleeve */}
                    <rect x="50" y="130" width="70" height="130" fill="#ececec" stroke="#333" strokeWidth="2" />
                    {/* Neckline */}
                    <circle cx="200" cy="100" r="25" fill="white" stroke="#333" strokeWidth="2" />
                    {/* Design Detail */}
                    <text x="200" y="250" textAnchor="middle" fontSize="24" fontWeight="bold" fill="#999">
                      SIDE
                    </text>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-bold">Boxy T-Shirt</h1>
            {/* T-Shirt Icon SVG */}
            <svg
          ...
          <p className="text-gray-600 font-light leading-relaxed">
            T-shirt boxy dengan potongan oversized yang trendy dan nyaman. Desain boxy cut memberikan tampilan yang relaxed dan modern, sempurna untuk casual styling. Bahan premium dari katun organik dengan finishing yang rapi.
          </p>
