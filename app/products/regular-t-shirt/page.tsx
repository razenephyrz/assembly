...
export default function RegularTShirtPage() {
  ...
  const specs = [
    ...
    { name: "Kain", value: "Komposisi: 100% katun organik. Berat: 150g/m²" },
    { name: "Struktur", value: "Jahit, Hilangan, Jersey, 24/1" },
    { name: "Penyelesaian", value: "Teknisi penyesuaian; gunner / penyawat tekstil penyederhauan" },
      ...
      <div className="grid grid-cols-2 gap-12 px-6 py-12 max-w-7xl mx-auto">
              ...
              <g id={`view-${slides[currentSlide].view}`}>
                {currentSlide === 0 && (
                  <>
                    {/* Front View */}
                    <path
                      d="M 100 80 L 80 120 L 75 200 L 70 400 L 330 400 L 325 200 L 320 120 L 300 80 Z"
                      fill="#f5f5f5"
                      stroke="#333"
                      strokeWidth="2"
                    />
                    {/* Sleeves */}
                    <rect x="20" y="120" width="80" height="120" fill="#f5f5f5" stroke="#333" strokeWidth="2" />
                    <rect x="300" y="120" width="80" height="120" fill="#f5f5f5" stroke="#333" strokeWidth="2" />
                    {/* Neckline */}
                    <circle cx="200" cy="85" r="25" fill="white" stroke="#333" strokeWidth="2" />
                    {/* Design Detail */}
                ...
                {currentSlide === 1 && (
                  <>
                    ...
                    />
                    {/* Sleeves */}
                    <rect x="20" y="120" width="80" height="120" fill="#e8e8e8" stroke="#333" strokeWidth="2" />
                    <rect x="300" y="120" width="80" height="120" fill="#e8e8e8" stroke="#333" strokeWidth="2" />
                    {/* Neckline */}
                    <circle cx="200" cy="85" r="25" fill="white" stroke="#333" strokeWidth="2" />
                    {/* Design Detail */}
                    <text x="200" y="250" textAnchor="middle" fontSize="24" fontWeight="bold" fill="#999">
                ...
                {currentSlide === 2 && (
                  <>
                    {/* Side View */}
                    <path
                      d="M 150 80 L 130 120 L 125 200 L 120 400 L 280 400 L 275 200 L 270 120 L 250 80 Z"
                      fill="#ececec"
                      stroke="#333"
                      strokeWidth="2"
                    />
                    {/* Sleeve */}
                    <rect x="60" y="120" width="70" height="120" fill="#ececec" stroke="#333" strokeWidth="2" />
                    {/* Neckline */}
                    <circle cx="200" cy="85" r="20" fill="white" stroke="#333" strokeWidth="2" />
                    {/* Design Detail */}
                    <text x="200" y="250" textAnchor="middle" fontSize="24" fontWeight="bold" fill="#999">
                      SIDE
                    </text>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-bold">Regular T-Shirt</h1>
            {/* T-Shirt Icon SVG */}
            <svg
          ...
          <p className="text-gray-600 font-light leading-relaxed">
            T-shirt regular yang sempurna untuk penggunaan sehari-hari dengan potongan standar yang nyaman. Dibuat dari bahan katun organik berkualitas tinggi dengan jahitan yang kuat dan durable. Tersedia dalam berbagai warna untuk melengkapi gaya Anda.
          </p>
